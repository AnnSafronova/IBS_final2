Action()
{
	...
	web_custom_request("AccountCreateRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountCreateRequest xmlns=\"com.advantage.online.store.accountservice\"><accountType>USER</accountType><address>Apple</address><allowOffersPromotion>true</allowOffersPromotion><cityName>Ulyanovsk</cityName><countryId>Russia,ru</countryId><email>annsafronova@mail.ru</"
		"email><firstName>Ann</firstName><lastName>Safronova</lastName><loginName>Safronova</loginName><password>Qwert123</password><phoneNumber>89877777777</phoneNumber><stateProvince>28</stateProvince><zipcode></zipcode></AccountCreateRequest></soap:Body></soap:Envelope>", 
		LAST);
	...
	web_custom_request("AccountCreateRequest_3", 
		"URL=https://www.advantageonlineshopping.com/accountservice/ws/AccountCreateRequest", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=text/xml", 
		...
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountCreateRequest xmlns=\"com.advantage.online.store.accountservice\"><accountType>USER</accountType><address>Apple</address><allowOffersPromotion>true</allowOffersPromotion><cityName>Ulyanovsk</cityName><countryId>Russia,ru</countryId><email>annsafronova@mail.ru</"
		"email><firstName>Anna</firstName><lastName>Safronova</lastName><loginName>Safronova</loginName><password>Qwert123</password><phoneNumber>89877777777</phoneNumber><stateProvince>28</stateProvince><zipcode></zipcode></AccountCreateRequest></soap:Body></soap:Envelope>", 
		LAST);
	...
	web_custom_request("AccountCreateRequest_4", 
		...
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountCreateRequest xmlns=\"com.advantage.online.store.accountservice\"><accountType>USER</accountType><address>Apple</address><allowOffersPromotion>true</allowOffersPromotion><cityName>Ulyanovsk</cityName><countryId>Russia,ru</countryId><email>annsafronova@mail.ru</"
		"email><firstName>Anna</firstName><lastName>Safronova</lastName><loginName>Safronova13</loginName><password>Qwert123</password><phoneNumber>89877777777</phoneNumber><stateProvince>28</stateProvince><zipcode></zipcode></AccountCreateRequest></soap:Body></soap:Envelope>", 
		LAST);
	...
	web_custom_request("AccountLoginRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountLoginRequest xmlns=\"com.advantage.online.store.accountservice\"><email>annsafronova@mail.ru</email><loginPassword>Qwert123</loginPassword><loginUser>Safronova13</loginUser></AccountLoginRequest></soap:Body></soap:Envelope>", 
		LAST);
	...
	web_url("614235788", 
		"URL=https://www.advantageonlineshopping.com/order/api/v1/carts/614235788", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.advantageonlineshopping.com/", 
		"Snapshot=t15.inf", 
	...
	web_custom_request("AccountLogoutRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountLogoutRequest xmlns=\"com.advantage.online.store.accountservice\"><loginUser>614235788</loginUser><base64Token>Basic U2Fmcm9ub3ZhMTM6UXdlcnQxMjM=</base64Token></AccountLogoutRequest></soap:Body></soap:Envelope>", 
		LAST);
